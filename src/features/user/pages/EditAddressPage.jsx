...
export default function EditAddressPage() {
  ...
  const loadAddress = async () => {
    try {
      ...
      setForm({
        ...
        phoneNumber: displayPhone, // Tampilkan tanpa 0 di depan karena UI sudah ada +62
        fullAddress: data.fullAddress || "",
        city: data.city || "",
        postalCode: data.postalCode || "",
        mainAddress: data.mainAddress || false, // Menggunakan isMainAddress atau mainAddress tergantung response BE
      });
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 2. Format Ulang Telepon (Tambah 0 di depan untuk disimpan ke DB)
